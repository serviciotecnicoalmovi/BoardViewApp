...
/// <summary>
/// Segmento Bézier cúbico definido por sus extremos y dos puntos de control.
/// </summary>
public sealed class BezierGraphic : GraphicObject
{
    public BezierGraphic(
        ...
        Point2D end,
        double width)
        : base(id, CreateBounds(start, control1, control2, end, width))
    {
        if (width < 0D)
        {
